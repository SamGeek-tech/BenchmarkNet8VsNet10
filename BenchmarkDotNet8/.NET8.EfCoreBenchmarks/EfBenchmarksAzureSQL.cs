...
{
    [MemoryDiagnoser]
    [SimpleJob(id: "AzureSQL")]
    public class EfBenchmarksAzureSQL
    {
        ...
        public void Setup()
        {
            ...
            _context = new AppDbContext(DatabaseProvider.AzureSQL);
            ...
            Console.WriteLine($"[EF Core Benchmark - Azure SQL] Database created");
        }
        ...
        public void Insert()
        {
            using (var context = new AppDbContext(DatabaseProvider.AzureSQL))
            {
