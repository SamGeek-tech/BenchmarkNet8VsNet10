...
namespace EfCoreBenchmarks
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("EF Core Benchmarks - .NET 8");
            ...
            // Debug mode
            /*  var azuresql = new EfBenchmarksInMemory();
              azuresql.Setup();
              azuresql.SimpleQuery();     // ← breakpoint here
              azuresql.Insert();     // ← breakpoint here
              azuresql.Cleanup();*/
              //var b = new EfBencmarks();
            //b.Setup();
            //b.SimpleQuery();     // ← breakpoint here
            //b.Cleanup();
        }
    }
}
